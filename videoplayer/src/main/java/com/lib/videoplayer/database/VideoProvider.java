...
public class VideoProvider extends ContentProvider {
    ...
    public static final String TABLE_EXTERNAL_MOVIE="external_video";
    ...
    public static final Uri CONTENT_URI_EXTERNAL_VIDEO_TABLE=Uri.parse(CONTENT_URI+"/"+TABLE_EXTERNAL_MOVIE);
    ...
    public interface VIDEO_COLUMNS {
        ...
        String HAS_PLAYED_IN_SEQUENCE = "has_played_in_sequence";
    ...
    public interface VIDEO_TYPE {
        ...
        String EXTERNAL_DISC="company_disc";
    ...
    private static final String CREATE_ADS_SLOTS_CONFIG_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + ADS_SLOTS_CONFIG_COLUMNS.SLOT_TYPE + " TEXT PRIMARY KEY ," + ADS_SLOTS_CONFIG_COLUMNS.SLOTS_PER_HOUR_COUNT + " INTEGER," + ADS_SLOTS_CONFIG_COLUMNS.ADS_PER_SLOT_COUNT + " INTEGER," + ADS_SLOTS_CONFIG_COLUMNS.CURRENT_RUNNING_AD_COUNT + " INTEGER DEFAULT 0 " + ")";


    private static final String CREATE_EXTERNAL_VIDEO_TABLE = "CREATE TABLE IF NOT EXISTS "
            + TABLE_VIDEO + "("
            + VIDEO_COLUMNS.VIDEO_ID + " TEXT PRIMARY KEY ," + VIDEO_COLUMNS.NAME + " TEXT," + VIDEO_COLUMNS.DOWNLOAD_URL + " TEXT," + VIDEO_COLUMNS.TYPE + " TEXT," + VIDEO_COLUMNS.LANGUAGE + " TEXT," + VIDEO_COLUMNS.MESSAGE + " TEXT," + VIDEO_COLUMNS.PATH + " TEXT," + VIDEO_COLUMNS.LAST_PLAYED_TIME + " TEXT," + VIDEO_COLUMNS.PLAY_COUNT + " INTEGER DEFAULT 0," + VIDEO_COLUMNS.DOWNLOADING_ID + " TEXT," + VIDEO_COLUMNS.DOWNLOAD_STATUS + " TEXT DEFAULT " + DOWNLOAD_STATUS.DOWNLOAD + "," + VIDEO_COLUMNS.TRANSACTION_ID + " TEXT," + VIDEO_COLUMNS.CLOUD_TIME + " TEXT," + VIDEO_COLUMNS.IS_PLAYING + " INTEGER DEFAULT 0,"+ VIDEO_COLUMNS.HAS_PLAYED_IN_SEQUENCE + " INTEGER DEFAULT 0," + VIDEO_COLUMNS.DELETE_STATUS + " INTEGER," + VIDEO_COLUMNS.RECEIVED_TIME + " TEXT," + VIDEO_COLUMNS.PRIORITY + " INTEGER DEFAULT 3 ," + VIDEO_COLUMNS.SELECTED_STATE + " INTEGER DEFAULT 0)";
    ...
    public boolean onCreate() {
        ...
        db.execSQL(CREATE_EXTERNAL_VIDEO_TABLE);
        return false;
    }

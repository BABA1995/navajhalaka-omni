...
public class MovieRVAdapter {

//    private List<Movie> mDataList;  56
...
//        holder.movieIcon.setTag(mDataList.get(position).getMoviePath());// binding imageview
//       // holder.movieIcon.setImageResource(R.mipmap.ic_movie); //default image
//        mVideoThumbLoader.showThumbByAsynctack(mDataList.get(position).getMoviePath(), holder.movieIcon);

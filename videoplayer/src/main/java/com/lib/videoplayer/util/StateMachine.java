...
public class StateMachine {
    ...
    public interface SEQUENCE_TYPE {
        ...
        String EXERNAL_HARD_DISK="External_disk";
    }
    ...
    public interface PLAYING_STATE {
        ...
        int EXERNAL_HARD_DISK_VIDEO =12;
        int OTHERS = 13;
        ...
        if (null != type) {
            switch (type) {
                ...
                case VideoProvider.VIDEO_TYPE.EXTERNAL_DISC:
                    return PLAYING_STATE.EXERNAL_HARD_DISK_VIDEO;
                default:
                    return PLAYING_STATE.OTHERS;
            }
        }
        return PLAYING_STATE.OTHERS;
    }
    ...
    private String getName(int aState) {
        switch (aState) {
            ...
            case PLAYING_STATE.EXERNAL_HARD_DISK_VIDEO:
                return "MOVIE";
    ...
    private String getStateName(int aState) {
        switch (aState) {
            ...
            case VIDEO_STATE.EXERNAL_HARD_DISK:
                return "EXERNAL_HARD_DISK";
            default:
                return "UNKNOWN";
        }
    }
    ...
    /*Saving ExternalFile Movie playing time*/
    public void ExtpersistState(long movieSeekTime, long mOtherSeekTime, long breakingSeekTime) {
        String selection = VideoProvider.VIDEO_INTERMEDIATE_COLUMNS.VIDEO_STATE + " = ?";
        String[] selectionArg = new String[]{"" + videoInfo.videoState};
        ContentValues lValues = new ContentValues();
        lValues.put(VideoProvider.VIDEO_INTERMEDIATE_COLUMNS.VIDEO_STATE, 2);
        lValues.put(VideoProvider.VIDEO_INTERMEDIATE_COLUMNS.PREV_STATE, 3);
        lValues.put(VideoProvider.VIDEO_INTERMEDIATE_COLUMNS.CURRENT_STATE, 3);
        if (null != videoInfo.movieUri) {
            lValues.put(VideoProvider.VIDEO_INTERMEDIATE_COLUMNS.MOVIE_URI, videoInfo.movieUri.toString());
        }
        if (0 != movieSeekTime) {

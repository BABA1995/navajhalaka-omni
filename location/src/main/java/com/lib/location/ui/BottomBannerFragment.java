...
public class BottomBannerFragment extends Fragment {
    ...
    private TextView mDistanceToDest,start,timeLeft,destination_start;
    ...
    private void initView() {
        ...
        start = (TextView) mRootView.findViewById(R.id.start);
        destination_start = (TextView) mRootView.findViewById(R.id.destination_start);
        timeLeft = (TextView) mRootView.findViewById(R.id.timeLeft);
        ...
        mDownloadingIcon= (ImageView) mRootView.findViewById(R.id.downloading_icon);
        progressBar = mRootView.findViewById(R.id.pb);
        mArea.setVisibility(View.GONE);
        mCurrentLocation.setVisibility(View.GONE);
        mCity.setVisibility(View.GONE);
        mDistanceToSource.setVisibility(View.GONE);
        mDistanceToDest.setVisibility(View.GONE);
        mTimeToDest.setVisibility(View.GONE);
    }
    ...
    public void onStart() {
        ...
        lFilter.addAction(DownloadManager.ACTION_DOWNLOAD_COMPLETE);
        ...
        lLocalFilter.addAction(CustomIntent.ACTION_DOWNLOAD_STARTED);
    ...
    public void onResume() {
        ...
        if (DownloadUtil.isDownloadGoingOn()){
            mDownloadingIcon.setVisibility(View.VISIBLE);
            progressBar.setProgress(1);
        }else {
            mDownloadingIcon.setVisibility(View.GONE);
        }
    }
        ...
        public void onReceive(Context context, Intent intent) {
            if (null != intent) {
                if (Intent.ACTION_TIME_TICK.equals(intent.getAction())) {
                    ...
                    if (null != mDownloadingIcon && mDownloadingIcon.getVisibility() == View.VISIBLE) {
                        if(!DownloadUtil.isDownloadGoingOn()) {
                            progressBar.setProgress(100);
                            mDownloadingIcon.setVisibility(View.GONE);
                        }
                    }
                }else if (CustomIntent.ACTION_DOWNLOAD_STARTED.equals(intent.getAction())) {
                    if (null != mDownloadingIcon && mDownloadingIcon.getVisibility() != View.VISIBLE) {
                        mDownloadingIcon.setVisibility(View.VISIBLE);
                    }
                }

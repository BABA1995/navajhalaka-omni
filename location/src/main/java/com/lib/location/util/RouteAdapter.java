...
public class RouteAdapter extends ArrayAdapter<Route> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
		 ...
		 *
		 * Therefore, route refers to the current Item object.
		 */
        ...
        if (route != null) {
            ...
            if (routeText != null) {
                routeText.setText(route.getmRouteSource() + " - " + route.getmRouteDestination());
                if (route.getSelection() == 1) {
                    routeText.setBackgroundColor(ContextCompat.getColor(getContext(),android.R.color.darker_gray));
                }else {
                    routeText.setBackgroundColor(ContextCompat.getColor(getContext(), android.R.color.white));
                }
            }
        }

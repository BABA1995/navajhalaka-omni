...
public class DownloadUtil {
    ...
    public static long beginDownload(Context context, String downloadUri, String name) {
        ...
        if (NetworkUtil.isInternetAvailable(context)) {
            ...
            LocalBroadcastManager.getInstance(RouteApplication.getRouteContext()).sendBroadcast(new Intent(CustomIntent.ACTION_DOWNLOAD_STARTED));
        }
    ...
    public static boolean isDownloadGoingOn() {
        DownloadManager downloadManager = (DownloadManager) RouteApplication.getRouteContext().getSystemService(Context.DOWNLOAD_SERVICE);
        DownloadManager.Query myDownloadQuery = new DownloadManager.Query();
        ...
        Logger.debug(TAG,"isDownloadGoingOn :: flag "+flag);
        return flag;
    }
}
